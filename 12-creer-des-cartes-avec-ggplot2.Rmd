...
Des packages externe permettent d'enrichir cette collection de thèmes, par exemple ggthemes ou hrbethemes.
...
ggplot(graphique1) +
  geom_point(aes(
    x = log(Gross_Domestic_Product_GDP),
