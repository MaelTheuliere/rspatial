...
`leaflet` intègre une fonction `colorBin()` qui permet d'associer à un vecteur un vecteur de couleur en fonction d'une palette et d'un vecteur de bornes.
...
Pour réaliser des ronds proportionnels, il va falloir comme pour `ggplot2` partir des centroide de nos polygones.
