...
On distingue 2 types d'opérations : les opérations unaires et binaires.
...
Ce package est une interace vers Mapshaper^[https://mapshaper.org/], une interface en ligne d'édition de données cartographiques.
...
Le découpage spatiale est une forme de filtre sur les géographie.
